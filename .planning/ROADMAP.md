...
- [ ] 97-11-PLAN.md — Restore the runtime-prefix recovery gate with explicit tenant scope on all three recovery operations.
...
|-------|----------------|--------|-----------|
| 97. Tenant Identity & Compatible Upgrade | 10/10 | In Progress|  |
