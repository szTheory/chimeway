...
- [ ] 101-20-PLAN.md — Bind logout to the exact authenticated session version and protect append-only notification-open history from parent deletion.
...
| 101. CrossWake Registration & Protected Open | 19/19 | In Progress|  |
