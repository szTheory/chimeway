# Requirements Archive: v1.17 Adopter Proof Paths

**Archived:** 2026-08-11
**Status:** SHIPPED

The live `.planning/REQUIREMENTS.md` is intentionally removed at milestone close and recreated when the next milestone starts.
