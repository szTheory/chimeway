...
- ✅ **v1.17 Adopter Proof Paths** — shipped 2026-08-11; [audit](v1.17-MILESTONE-AUDIT.md)
...
- [x] **Phase 96: Adoption Front Door & Proof Gate** - Adopters can select, run, and trust the three proof paths through contract-checked guidance and one focused CI lane. (completed 2026-08-11)
- [x] **Phase 96.1: Atom-Safe Archive Metadata Parsing** - Caller-controlled Hex metadata is parsed with bounded binary-only semantics while real artifact proofs retain their validation and redaction behavior. (completed 2026-08-11)
...
### Phase 96.1: Atom-Safe Archive Metadata Parsing
...
**Depends on:** Phase 96
**Requirements:** ARCHIVE-ATOM-01 audit gap closure supporting the 13 original milestone requirements
...
---
*Archived: 2026-08-11 — v1.17 shipped after a passed 13/13 requirements, 5/5 phases, 11/11 integration, and 4/4 flows audit.*
