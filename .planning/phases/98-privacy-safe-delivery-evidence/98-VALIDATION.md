...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 98-01-01 | 01 | 1 | PRIV-03, PRIV-04 | T-98-01/T-98-02 | A hostile adapter result becomes bounded durable attempt evidence and a tenant-scoped safe trace. | tracer/integration | `env MIX_ENV=test mix test test/chimeway/privacy_boundary_test.exs --warnings-as-errors` | ❌ W0 | ⬜ pending |
...
| 98-04-02 | 04 | 4 | PRIV-03, PRIV-04 | T-98-04-02/T-98-04-03 | Core Admin DTOs are safe before optional recursive view defense. | integration | `env MIX_ENV=test mix test test/chimeway/admin_test.exs --warnings-as-errors && mix verify.admin` | Existing suites; phase cases pending | ⬜ pending |
