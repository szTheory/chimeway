defmodule Chimeway.Admin do
  ...
  defp maybe_filter_event_tenant(query, nil), do: query
  defp maybe_filter_event_tenant(query, ""), do: query

  defp maybe_filter_event_tenant(query, tenant_id) do
    where(query, [_e, _n, d], d.tenant_id == ^tenant_id)
  end
