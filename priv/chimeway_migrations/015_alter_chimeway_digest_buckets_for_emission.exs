...
defmodule Chimeway.Repo.Migrations.AlterChimewayDigestBucketsForEmission do
  use Ecto.Migration

  @chimeway_prefix __CHIMEWAY_PREFIX__

  def change do
    alter chimeway_table(:chimeway_digest_buckets) do
    ...
    create(chimeway_index(:chimeway_digest_buckets, [:flush_state]))
    create(chimeway_index(:chimeway_digest_buckets, [:digest_delivery_id]))
  end
